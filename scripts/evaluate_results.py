...
GT_PATH = os.path.join(args.ground_truth, 'txts')
DR_PATH = os.path.join(os.getcwd(), 'model_detection_txts')
...
with open(results_files_path + "/results.txt", 'w') as results_file:
    ...
    for class_index, class_name in enumerate(gt_classes):
        ...
        # kopi mark
        if class_name == "car":
            with open("/tmp/results.txt", "a") as myfile:
                myfile.write("{0:.2f}\n".format(ap*100))
        ...
        if not args.quiet and class_name == "car":
            print(text)
